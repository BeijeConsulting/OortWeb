...
/**
 * Servlet implementation class ModificaBiblio
 */
@WebServlet("/ModificaBiblio")
public class ModificaBiblio extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ModificaBiblio() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(page != null) {
			...
			case "libro":{
				...
				JPADBtools.updateLibro(1,titolo, descrizione, Integer.parseInt(id_autore), Integer.parseInt(id_editore), anno);
